...
std::shared_ptr<TOperator> creature_internal::_select_genetic_operator(const std::vector<const TMetadata*> operator_metadata,
...
std::shared_ptr<crossover> creature_internal::_select_crossover(const std::vector<const crossover_metadata_t*>& crossover_metadata) const {
    genetic_factory& factory = genetic_factory::get_instance();
...
std::shared_ptr<mutation> creature_internal::_select_mutation(const std::vector<const mutation_metadata_t*>& mutation_metadata) const {
    genetic_factory& factory = genetic_factory::get_instance();
